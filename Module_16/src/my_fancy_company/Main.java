package my_fancy_company;

import my_fancy_company.connection_handler.ConnectionHandler;
import my_fancy_company.model.Impiegati;
...
public class Main {
    public static void main(String[] args) throws SQLException, ClassNotFoundException {
        ...
        ps_aggiorna_dipendente.setString(1, "Alessio");
